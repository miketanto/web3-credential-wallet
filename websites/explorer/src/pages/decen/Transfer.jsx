      ...
      <Box className="border-illini-orange-100 w-full max-w-sm sm:max-w-md md:max-w-lg" noFlex rounded="2xl">
        ...
        <div className="flex flex-col items-center py-2 text-illini-blue text-xl">
          ...
          <div className="-mt-3 z-20">
            <div className="flex items-center justify-center h-10 w-10 text-teal-500 bg-teal-100 border-4 border-white text-lg rounded-full">
          ...
          <div className="w-full pt-3">
            <button
              className="w-full p-3 text-teal-600 bg-teal-100 border border-transparent hover:bg-teal-200 font-semibold rounded-2xl transition"
              type="button"
            >
              Connect Wallet
            </button>
