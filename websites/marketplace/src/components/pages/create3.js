...
constructor() {
  ...
  updateTitle = (e) => {
    ...
    this.setState({
      title: newTitle == "" ? "Pink Ocean" : newTitle
    });
  }
          ...
          <div className="col-lg-7 offset-lg-1 mb-5">
              <form id="form-create-item" className="form-border" action="#">
                  <div className="field-set">
                      ...
                      <input onClick={this.loading} type="button" id="submit" className="btn-main" value="Create Item"/>
                  </div>
              </form>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-xs-12">
                  ...
                  <div className="nft__item m-0">
                      ...
                      <div className="nft__item_wrap">
                          <span>
                            <img src={this.state.files.length == 0 ? "./img/collections/coll-item-3.jpg" : URL.createObjectURL(this.state.files[0])} id="get_file_2" className="lazy nft__item_preview" alt=""/>
                          </span>
                      </div>
                      <div className="nft__item_info">
                          ...
                          <div className="nft__item_price">
                            {this.state.price} ETH<span>1/20</span>
                          </div>
